...
" syn match Number /\v[0-9.]+/ containedin=bResult
" highlight Number guifg=lightgrey
syn match Grams /\v(^│[a-zA-Z ]+│\s+)@<=[-0-9.]+/ containedin=bResult
...
syntax region bResult start=/\v\/\*\+/ end=/\v\+\*\// contains=Ingredient,Box,Grams,Constant,Part,Number
